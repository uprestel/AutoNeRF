...
class NeRF(torch.nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.model = nn.Sequential([
            ...
            # Layer 3 (default: 128 -> 64)
            torch.nn.Linear(filter_size, 64),
            # Layer 3 (default: 64 -> 32)
    ...
    def get_ray_bundle(self, height: int, width: int, focal_length: float, tform_cam2world: torch.Tensor):
    ...
    def run_one_iter_of_tinynerf(height, width, focal_length, tform_cam2world,
        ...
        ray_origins, ray_directions = self.get_ray_bundle(height, width, focal_length,
                                                    tform_cam2world)
        
        # Sample query points along each ray
        query_points, depth_values = self.compute_query_points_from_rays(
